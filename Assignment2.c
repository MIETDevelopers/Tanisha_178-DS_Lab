//A C program to compare the running times (in milliseconds) of Bubble Sort and Merge Sort.
#include<stdio.h>
#include<stdlib.h>
...
Merge sort needs an auxiliary array (extra space) to sort and cause more memory access & gives a faster response. Bubble sort may perform better for small data set but for larger data Merge Sort is preferred.
*/
